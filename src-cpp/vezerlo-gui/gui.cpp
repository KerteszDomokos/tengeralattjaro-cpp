...
void GUI::joydat()
{
    ...
    QFile file("C:/Users/Kertész Domokos/Desktop/.Programozás/Projektek/Tengeralattjáró/v1 - Github/tengeralattjaro-cpp/src-cpp/vezerlo-gui/program-datas/joystick.txt");
